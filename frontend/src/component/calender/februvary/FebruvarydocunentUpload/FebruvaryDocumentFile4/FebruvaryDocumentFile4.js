...
import "./FebruvaryDocumentFile4.css";
import Navbar from "../../../../Navbar/Navbar";

const FebruvaryDocumentFile4 = () => {
  return (
    <div>
      <Navbar />
      <div className="Table__MiddleNavbar__tableActionPage__FebFourth">
      ...
      <div className="Januavary__Fourth__Container">
...
export default FebruvaryDocumentFile4;
