...
import "./FebruvaryDocumentFile1.css";
import Navbar from "../../../../Navbar/Navbar";
import Footer from "../../../../../components/InnerComponents/footer/Footer";

const FebruvaryDocumentFile1 = () => {
  return (
    <div>
      <Navbar />
      <div className="Table__MiddleNavbar__tableActionPage__MonthJan">
      ...
      <div className="DocumentFile1__Januavary__Container">
        <div className="DocumentFile1__TableActionPage9__ContainerFirst">
          <span className="DocumentFile1__TableActionPage9__Inner">
            <span className="TableActionPage9__Calender">
              <img
                src={word}
                className="DocumentFile1__InnerImage__TableActionPage9"
                alt=""
              />
            </span>
          </span>
          <p className="DocumentFile1__TableActionPAge9__InnerCalenderText">
            Élégance Pieds SARL{" "}
          </p>
        </div>
        <div className="DocumentFile1__TableActionPage9__ContainerFirst">
      ...
      <div className="DocumentFile1__Januavary__ContainerSecond">
        <div className="DocumentFile1__TableActionPage9__ContainerFirst">
          <span className="DocumentFile1__TableActionPage9__Inner">
            <span className="TableActionPage9__Calender">
              <img
...
export default FebruvaryDocumentFile1;
