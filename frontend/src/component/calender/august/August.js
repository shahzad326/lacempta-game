...
const August = () => {
  return (
   ...
   <Navbar />
      ...
      <div className="Table__MiddleNavbar__tableActionPage__August">
        ...
        <div className="MiddleNavbar__Container__TableActionPage">
          <div className="MiddleNavbar__HomeContainer__TableActionPage">
            ...
            <div className="MiddleNavbar__ForwardContainer__Page">
              ...
              <div className="MiddleNavbar__MidText">Aout </div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="24"
      ...
      <div className="August__Container">
        <div className="TableActionPage9__ContainerFirst">
          <span className="TableActionPage9__Inner__August">
            <span className="TableActionPage9__Calender">
              <img
                src={banque}
                className="InnerImage__TableActionPage9__August"
                alt=""
              />
            </span>
          </span>
          <p className="TableActionPAge9__InnerCalenderText__August">Charges </p>
        </div>
        <div className="TableActionPage9__ContainerFirst">
          <span className="TableActionPage9__Inner__August">
            <span className="TableActionPage9__Calender">
          ...
          <p className="TableActionPAge9__InnerCalenderText__August">Products</p>
        </div>
        <div className="TableActionPage9__ContainerFirst">
          <span className="TableActionPage9__Inner__August">
            <span className="TableActionPage9__Calender">
          ...
          <p className="TableActionPAge9__InnerCalenderText__August">Banque</p>
        </div>
      </div>
    </div>
  );
