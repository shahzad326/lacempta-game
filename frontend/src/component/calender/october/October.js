...
const October = () => {
  ...
  return (
    <div>
      ...
      <div className="Table__MiddleNavbar__tableActionPage__October">
        ...
        <div className="MiddleNavbar__Container__TableActionPage">
          <div className="MiddleNavbar__HomeContainer__TableActionPage">
            ...
            <div className="MiddleNavbar__ForwardContainer__Page">
              ...
              <div className="MiddleNavbar__MidText">Octobre </div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="24"
      ...
      <div className="October__Container">
        <div className="TableActionPage9__ContainerFirst">
          <span className="TableActionPage9__Inner__October">
            <span className="TableActionPage9__Calender">
              <img
                src={banque}
                className="InnerImage__TableActionPage9__October"
                alt=""
              />
            </span>
          </span>
          <p className="TableActionPAge9__InnerCalenderText__October">
            Charges{" "}
          </p>
        </div>
        <div className="TableActionPage9__ContainerFirst">
        ...
        <div className="TableActionPage9__ContainerFirst">
          ...
          <p className="TableActionPAge9__InnerCalenderText__October">Banque</p>
        </div>
      </div>
    </div>
  );
