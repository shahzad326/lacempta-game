...
const November = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="Table__MiddleNavbar__tableActionPage__November">
        ...
        <div className="MiddleNavbar__Container__TableActionPage">
          <div className="MiddleNavbar__HomeContainer__TableActionPage">
            ...
            <div className="MiddleNavbar__ForwardContainer__Page">
              ...
              <div className="MiddleNavbar__MidText">Novembre </div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="24"
      ...
      <div className="November__Container">
        <div className="TableActionPage9__ContainerFirst">
          <span className="TableActionPage9__Inner__November">
            <span className="TableActionPage9__Calender">
              <img
                src={banque}
                className="InnerImage__TableActionPage9__November"
                alt=""
              />
            </span>
          </span>
          <p className="TableActionPAge9__InnerCalenderText__November">
            Charges{" "}
          </p>
        </div>
        <div className="TableActionPage9__ContainerFirst">
