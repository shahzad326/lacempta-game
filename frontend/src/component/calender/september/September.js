...
const September = () => {
  ...
  return (
    <div>
      ...
      <div className="Table__MiddleNavbar__tableActionPage__September">
        ...
        <div className="MiddleNavbar__Container__TableActionPage">
          <div className="MiddleNavbar__HomeContainer__TableActionPage">
            ...
            <div className="MiddleNavbar__ForwardContainer__Page">
              ...
              <div className="MiddleNavbar__MidText">Septembre </div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="24"
              ...
              >
                <path
                  d="M9.09717 5L16.0972 12L9.09717 19"
                  stroke="#3F3F46"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
      ...
      <div className="September__Container">
        <div className="TableActionPage9__ContainerFirst">
          <span className="TableActionPage9__Inner__September">
            <span className="TableActionPage9__Calender">
              <img
                src={banque}
                className="InnerImage__TableActionPage9__September"
                alt=""
              />
            </span>
          </span>
          <p className="TableActionPAge9__InnerCalenderText__September">
            Charges{" "}
          </p>
        </div>
        <div className="TableActionPage9__ContainerFirst">
        ...
        <div className="TableActionPage9__ContainerFirst">
          ...
          <p className="TableActionPAge9__InnerCalenderText__September">
            Opérations <br /> Diverses
          </p>
        </div>
      </div>

      <div className="september__LastContainerButton__Container">
        <div className="September__button__First__Container">
          <div className="September__firstButtonText__Container">
            Opérations Diverses
          </div>
        </div>
      </div>
