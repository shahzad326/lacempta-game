...
import "./SeptemberDocumentFile4.css";
import Navbar from "../../../../Navbar/Navbar";

const SeptemberDocumentFile4 = () => {
  return (
    <div>
      <Navbar />

      <div className="Document4__Table__MiddleNavbar__tableActionPage">
      ...
      <div className="Document4__Januavary__Fourth__Container">
        <div className="TableActionPage9__ContainerFirst">
          <span className="DocumentFile4__TableActionPage9__Inner">
            <span className="TableActionPage9__Calender">
              <img
                src={word}
                className="DocumentFile4__InnerImage__TableActionPage9"
                alt=""
              />
            </span>
          </span>
          <p className="DocumentFile4__TableActionPAge9__InnerCalenderText">
            1er acompte IS
          </p>
        </div>
...
export default SeptemberDocumentFile4;
