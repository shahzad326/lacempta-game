...
import word33 from "../../../../../images/word33.png";

import "./SeptemberDocumentFile3.css";
import Navbar from "../../../../Navbar/Navbar";
import Footer from "../../../../../components/InnerComponents/footer/Footer";

const SeptemberDocumentFile3 = () => {
  return (
    <div>
      <Navbar />
      <div className="DocumentF3__Table__MiddleNavbar__tableActionPage">
        ...
        <div className="MiddleNavbar__Container__TableActionPage">
          <div className="MiddleNavbar__HomeContainer__TableActionPage">
            ...
            <div className="MiddleNavbar__ForwardContainer__Page">
              ...
              <div className="MiddleNavbar__MidText">Banque</div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="24"
      ...
      <div className="DocumentF3__Januavary__Second__Container">
        <div className="TableActionPage9__ContainerFirst">
          <span className="DocumentF3__TableActionPage9__Inner">
            <span className="TableActionPage9__Calender">
              <img
                src={word33}
                className="DocumentF3__InnerImage__TableActionPage9"
                alt=""
              />
            </span>
          </span>
          <p className="DocumentF3__TableActionPAge9__InnerCalenderText">
            Relevé Janvier
          </p>
        </div>
      </div>
...
export default SeptemberDocumentFile3;
