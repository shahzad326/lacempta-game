...
import word from "../../../../../images/word 1.png";

import "./DecemberDocumentFile4.css";
import Navbar from "../../../../Navbar/Navbar";

const DecemberDocumentFile4 = () => {
  return (
    <div>
      <Navbar />
      <div className="Table__MiddleNavbar__tableActionPage__DecLast">
        ...
        <div className="MiddleNavbar__Container__TableActionPage">
          <div className="MiddleNavbar__HomeContainer__TableActionPage">
            ...
            <div className="MiddleNavbar__ForwardContainer__Page">
              ...
              <div className="MiddleNavbar__MidText">Opérations Diverses</div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="24"
      ...
      <div className="December__FIRst__Fourth__Container">
        <div className="TableActionPage9__ContainerFirst">
          <span className="TableActionPage9__Inner__DecLast">
            <span className="TableActionPage9__Calender">
              <img
                src={word}
                className="InnerImage__TableActionPage9__DecLast"
                alt=""
              />
            </span>
          </span>
          <p className="TableActionPAge9__InnerCalenderText__DecLast">CFE</p>
        </div>
        <div className="TableActionPage9__ContainerFirst">
          <span className="TableActionPage9__Inner__DecLast">
            <span className="TableActionPage9__Calender">
          ...
          <p className="TableActionPAge9__InnerCalenderText__DecLast">
            4eme Accompte IS
          </p>
        </div>
        <div className="TableActionPage9__ContainerFirst">
      ...
      <div className="December__Second__Fourth__Container">
        <div className="TableActionPage9__ContainerFirst">
          <span className="TableActionPage9__Inner__DecLast">
            <span className="TableActionPage9__Calender">
              <img
...
export default DecemberDocumentFile4;
