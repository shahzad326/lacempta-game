...
const December = () => {
  return (
    <div>
      ...
      <div className="Table__MiddleNavbar__tableActionPage__December">
        ...
        <div className="MiddleNavbar__Container__TableActionPage">
          <div className="MiddleNavbar__HomeContainer__TableActionPage">
            ...
            <div className="MiddleNavbar__ForwardContainer__Page">
              ...
              <div className="MiddleNavbar__MidText">Décembre </div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="24"
      ...
      <div className="December__Container">
        <div className="TableActionPage9__ContainerFirst">
          <span className="TableActionPage9__Inner__December">
            <span className="TableActionPage9__Calender">
              <img
                src={banque}
                className="InnerImage__TableActionPage9__December"
                alt=""
              />
            </span>
          </span>
          <p className="TableActionPAge9__InnerCalenderText__December">
            Charges{" "}
          </p>
        </div>
        <div className="TableActionPage9__ContainerFirst">
      ...
      <div className="December__LastContainerButton__Container">
        <div className="December__button__First__Container">
          <div className="December__firstButtonText__Container">
            Opérations Diverses
          </div>
        </div>
      </div>
