...
import "./RechercheuneécritureCopy.css";
import Navbar from "../../Navbar/Navbar";
import RechercheuneécritureMiddleNavbar from "../Rechercheuneécriture/RechercheuneécrituremiddleNavbar/RechercheuneécritureMiddleNavbar";
...
const RechercheuneécritureCopy = () => {
    ...
    <div>
      ...
      <div className="MainTable__Rechercheuneécriture__ThirdNavbar">
        ...
        <div className="MainTable__Rechercheuneécriture__ThirdContainer">
          ...
          <div className="MainTable__Rechercheuneécriture__ThirdInnerContainer">
            <div className="InnerContainer__Thirdheading">Entrer du texte</div>
          </div>
        </div>
...
export default RechercheuneécritureCopy;
