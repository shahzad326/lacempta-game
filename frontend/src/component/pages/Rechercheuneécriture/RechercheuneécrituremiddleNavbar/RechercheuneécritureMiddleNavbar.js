...
import "./RechercheuneécritureMiddleNavbar.css";

const RechercheuneécritureMiddleNavbar = () => {
  return (
    <div>
      <div className="Main-Table__MiddleNavbar">
        <span className="Main-MiddleNavbar__Arrow">
          <svg
        ...
        <div className="MiddleNavbar__Container">
          ...
          <div className="Table-MiddleNavbar__ForwardContainer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="25"
              height="24"
          ...
          <div className="MiddleNavbarSecond__container">
            <div className="MiddleNavbarText">
              <p className="MiddleNavbarInnerText">Saisir une écriture</p>
            </div>

            <div className="Table__MidlleNavbar-ForwardContainer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="25"
                height="24"
            ...
            <div className="MiddleNavbarText">
              <p className="MiddleNavbarInnerText"> Journal des achats</p>
            </div>
          </div>
        </div>
      </div>
...
export default RechercheuneécritureMiddleNavbar;
