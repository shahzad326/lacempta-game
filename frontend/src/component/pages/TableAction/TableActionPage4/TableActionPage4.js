...
import "./TableActionPage4.css";

const TableActionPage4 = () => {
  return (
    <div>
        ...
        <div className="MiddleNavbar__Container__TableActionPage">
          <div className="MiddleNavbar__HomeContainer__TableActionPage">
            ...
            <div className="MiddleNavbar__ForwardContainer__Page">
              ...
              <div className="MiddleNavbar__LastText">Balance </div>
            </div>
          </div>
        </div>
      </div>
            ...
            <tr className="Rechercheuneécriture__AllTableHeadingInner">
              <td className="Rechercheuneécriture__tableHeading__Inner__TableActionPage4">
                ...
                <span className="TableActionPage3__innerTextPage4">
                  Total Compte 101 - Capital Social
                </span>
              </td>
            </tr>
            <tr className="Rechercheuneécriture__AllTableHeadingInner">
      ...
      <div className="TableActionPage3__ButtonContainer">
        <div className="TableActionPage3__InnerContainer">
          <span className="TableInnerPage3__text">
            Il’l give you the full list of accounts to be implemented{" "}
          </span>
        </div>
      </div>
...
export default TableActionPage4;
