...
import "./TableActionPage3.css";

const TableActionPage3 = () => {
  const data = [
  ...
  return (
    <div>
        ...
        <div className="MiddleNavbar__Container__TableActionPage">
          <div className="MiddleNavbar__HomeContainer__TableActionPage">
            ...
            <div className="MiddleNavbar__ForwardContainer__Page">
              ...
              <div className="MiddleNavbar__LastText">Plan Comptable </div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="TableActionPage3__ButtonContainer">
        <div className="TableActionPage3__ButtonInnerContainer">
          <span className="TableActionPage3__ButtonContainer__Text">
            Toutes les classes de comptes
          </span>
        </div>
      </div>
      ...
      <div className="Rechercheuneécriture__TableContainer">
        <table>
          <thead>
            <tr className="Rechercheuneécriture__AllTableHeading">
              ...
              <td className="Rechercheuneécriture__tableHeading">
                <span className="Rechercheuneécriture__tableHeadingText__Second">
                  Journaux
                </span>{" "}
              </td>
            </tr>
          ...
          <tbody>
            <tr className="Rechercheuneécriture__AllTableHeadingInner">
              <td className="Rechercheuneécriture__tableHeading__Inner__TableActionPage">
                <span className="TableActionPage3__innerText">10</span>
              </td>
              <td className="Rechercheuneécriture__tableHeading__Second">
                <span className="TableActionPage3__innerText__second">
                  Capital Social
                </span>
              </td>
            </tr>
...
export default TableActionPage3;
