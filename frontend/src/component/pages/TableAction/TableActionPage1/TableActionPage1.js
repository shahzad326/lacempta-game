...
import "./TableActionPage1.css";

const TableActionPage1 = () => {
  const data = [
    [
      "12/09/23",
      "AC",
  ...
  return (
    <div>
      ...
      <div className="TableActionPage__TableContainer">
        <table className="TableActionPage__MainTable">
          <thead>
      ...
      <div className="TablefooterNavbar">
...
export default TableActionPage1;
