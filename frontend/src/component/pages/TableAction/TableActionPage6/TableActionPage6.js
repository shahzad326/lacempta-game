...
import "./TableActionPage6.css";

const TableActionPage6 = () => {
  return (
    <div>
        ...
        <div className="MiddleNavbar__Container__TableActionPage">
          <div className="MiddleNavbar__HomeContainer__TableActionPage">
            ...
            <div className="MiddleNavbar__ForwardContainer__Page">
              ...
              <div className="MiddleNavbar__LastText">Grand Livre </div>
            </div>
          </div>
        </div>
      </div>

      <div className="TableActionPage3__ButtonContainer__Page5">
        <div className="TableActionPage3__ButtonInnerContainer__Page5">
          <span className="TableInnerPage3__text__Page5">+</span>
          <span className="TableInnerPage3__text__Page5">
      ...
      <div className="Rechercheuneécriture__TableContainer">
        <table>
          <thead>
            <tr className="Rechercheuneécriture__AllTableHeading__Page4">
              <td className="Rechercheuneécriture__tableHeading__Page4">
                <span className="Rechercheuneécriture__tableHeadingText">
                  Date
                </span>{" "}
              </td>
              <td className="Rechercheuneécriture__tableHeading__Page4__Heading1">
                <span className="Rechercheuneécriture__tableHeadingText">
                  Compte
                </span>{" "}
              </td>
              <td className="Rechercheuneécriture__tableHeading__Page4__Heading2">
                <span className="Rechercheuneécriture__tableHeadingText">
                  Libellé
                </span>{" "}
              </td>
              <td className="Rechercheuneécriture__tableHeading__Page4__Heading5">
                <span className="Rechercheuneécriture__tableHeadingText">
                  Code lettrage
                </span>{" "}
              </td>
              <td className="Rechercheuneécriture__tableHeading__Page4__Heading3">
                <span className="Rechercheuneécriture__tableHeadingText">
                  Débit
                </span>{" "}
              </td>{" "}
              <td className="Rechercheuneécriture__tableHeading__Page4__Heading4">
                <span className="Rechercheuneécriture__tableHeadingText">
                  Crédit
                </span>{" "}
              </td>
              <td className="Rechercheuneécriture__tableHeading__Page4__Heading6">
                <span className="Rechercheuneécriture__tableHeadingText">
                  No de Piece
                </span>{" "}
              </td>
              <td className="Rechercheuneécriture__tableHeading__Page4__Heading7">
                <span className="Rechercheuneécriture__tableHeadingText">
                  Actions
                </span>{" "}
              </td>
          ...
          <tbody>
            <tr className="Rechercheuneécriture__AllTableHeadingInner">
              <td className="Rechercheuneécriture__tableHeading__Inner__TableActionPage4">
                <span className="Svg__TableActionPage4__icon">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="54"
                    height="54"
                  ...
                  >
                    <path
                      d="M22.2998 37.9095L33.4498 26.7595L22.2998 15.6095L22.2998 37.9095Z"
                      fill="black"
                    />
                  </svg>
                </span>
                <span className="TableActionPage3__innerTextPage4">
                  101000 - Capital
                </span>
              </td>
            </tr>
      ...
      <div className="TableActionPage__Footer__page5">
...
export default TableActionPage6;
