...
import Container from "../../../images/asaview-3d-keyboard-buttons (1) 1.png";
import Reactangle from "../../../images/Rectangle 25.png";
import Reactangle25 from "../../../images/Rectangle 29.png";
import fourth from "../../../images/Rectangle 65.png";
import fifth from "../../../images/Rectangle 27.png";
import seven from "../../../images/Rectangle 66.png";
import information from "../../../images/information 1.png";
import Calculator from "../../../images/calculator 2.png";
import Dialogue3 from "../homeScreen/displayDialogue/Dialogue3/Dialogue3";
  ...
  return (
    <div>
      ...
      <div className="middle__Navbar">
        <div className="middle__Navbar__left">
          <div className="Navbar__left__imageContainer">
            <div className="Navbar__left__image">
              <img src={Avatar} alt="" />
            </div>
          </div>
          <div className="Navbar__left__textContainer">
            <span className="Navbar__leftTextContainer">
              <span className="Left__initital">Hello,</span>
              <span className="RightInitial">[Name of the customer]</span>
            </span>
          </div>
        </div>
        <div className="middle__Navbar__right">
          <div className="right__image__container">
            <img src={Iphone} alt="" />
          </div>

          <div className="right__button__Container">
            <span className="right__buttonText">Aide</span>
          </div>

          <div className="right__TextContainer">
            <span className="right__buttonText">Se déconnecter</span>
          </div>
        </div>
      </div>

      {isPopupVisible && <Dialogue3 onClose={handleClosePopup} />}

      <div className="Screen5__MainAllContainer">
        <div className="instance-parent">
          <div
            className="Screen5__MainContainer__One"
            onClick={handleContainerClick}
          >
            <img
              className="Screen5__MainContainer__Image"
              alt=""
              src={Container}
            />
          </div>
          <div className="saisies-parent">
            ...
            <div className="frame-wrapper2">
              <div className="voir-parent">
                ...
                >
                  <path
                    d="M12.3606 8.65661C12.2933 8.59393 12.2394 8.51835 12.2019 8.43437C12.1645 8.35038 12.1444 8.25972 12.1428 8.1678C12.1412 8.07587 12.1581 7.98455 12.1925 7.8993C12.2269 7.81405 12.2782 7.73661 12.3432 7.6716C12.4082 7.60658 12.4857 7.55533 12.5709 7.5209C12.6562 7.48646 12.7475 7.46955 12.8394 7.47118C12.9313 7.4728 13.022 7.49292 13.106 7.53034C13.19 7.56776 13.2655 7.62171 13.3282 7.68898L16.9797 11.3404C17.0434 11.4039 17.0939 11.4793 17.1284 11.5623C17.1629 11.6453 17.1807 11.7343 17.1807 11.8243C17.1807 11.9142 17.1629 12.0032 17.1284 12.0862C17.0939 12.1692 17.0434 12.2446 16.9797 12.3081L13.3282 15.9595C13.2655 16.0268 13.19 16.0807 13.106 16.1182C13.022 16.1556 12.9313 16.1757 12.8394 16.1773C12.7475 16.179 12.6562 16.162 12.5709 16.1276C12.4857 16.0932 12.4082 16.0419 12.3432 15.9769C12.2782 15.9119 12.2269 15.8345 12.1925 15.7492C12.1581 15.664 12.1412 15.5726 12.1428 15.4807C12.1444 15.3888 12.1645 15.2981 12.2019 15.2141C12.2394 15.1302 12.2933 15.0546 12.3606 14.9919L14.8436 12.5089H5.99792C5.81634 12.5089 5.64219 12.4368 5.5138 12.3084C5.3854 12.18 5.31327 12.0058 5.31327 11.8243C5.31327 11.6427 5.3854 11.4685 5.5138 11.3401C5.64219 11.2117 5.81634 11.1396 5.99792 11.1396H14.8436L12.3606 8.65661Z"
                    fill="white"
                  />
                </svg>
              </div>
        ...
        <div className="instance-parent">
          <div className="Screen5__MainContainerSecond">
            <img
              className="Screen5__SecondContainerImage"
              alt=""
              src={Reactangle}
            />
          </div>
          <div className="frame-parent2">
            <div className="comptes-parent">
              ...
              <div className="consulter-les-comptes-container">
        ...
        <div className="instance-parent">
          <div className="rectangle-container">
            <img className="instance-item" alt="" src={Reactangle25} />
          </div>
        ...
        <div className="instance-parent">
          <div className="screen5__FourthContainer">
            <img className="instance-inner" alt="" src={fifth} />
          </div>
          <div className="tats-parent">
        ...
        <div className="instance-parent">
          <img className="frame-inner" alt="" src={seven} />
          <div className="documents-comptables-parent">
            <b className="tats">
              <p className="documents">Documents</p>
              <p className="documents">Comptables</p>
            </b>
            <div className="facturesdachat">
        ...
        <div className="instance-parent">
          <img className="frame-inner" alt="" src={fourth} />
          <div className="ressources-pdagogiques-parent">
            <b className="tats">
              <p className="documents">Ressources</p>
              <p className="documents">Pédagogiques</p>
            </b>
            <div className="saisir-une-criture">Documents pdf</div>
            <div className="frame-wrapper2">
              <div className="voir-parent">
                <div className="se-dconnecter">Voir</div>
                <svg
