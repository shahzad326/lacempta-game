  ...
  return (
    <div>
      ...
      <div className="HomeContainer__Text">
        <p className="HomeConteiner__InnerText">
          Aide - Comprendre comment fonctionne ce jeu
        </p>

        <div className="HomeContainer__SecondText">
          Cette partie est destinée à vous guider dans l’utilisation et les
          fonctionnalités du jeu. Elle est également disponible pour comprendre
          des mécanismes et technniques comptabes.
        </div>
      </div>

      <div className="frame-parent1">
        <div className="instance-parent">
          <div className="asaview-3d-keyboard-buttons-1-wrapper">
            <img
              className="asaview-3d-keyboard-buttons-1-icon"
              alt=""
              src={Container}
            />
          </div>
        ...
        <div className="instance-parent">
          <div className="rectangle-wrapper__second">
            <img className="instance-child__second" alt="" src={Reactangle} />
          </div>
